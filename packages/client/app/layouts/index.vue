  ...
  <el-container style="height: 100vh">
    <el-aside class="layout-aside" v-if="!sidebarHidden" width="auto">
      <transition name="slide">
        <h5 class="aside-title" style="text-align: center">知音</h5>
      </transition>
    ...
    <el-container>
      <el-header height="40px">
        ...
        <div v-if="store.user && store.user.token" class="toolbar" v-for="toolkit of toolkits" :key="toolkit.name">
          ...
          >
            <template #reference>
              <el-badge :value="toolkit.badge?toolkit.badge():undefined">
...
import { routes, getValue,store,toolkits } from '@zhinjs/client'
