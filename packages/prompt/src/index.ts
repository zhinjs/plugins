...
export function install(bot:Bot,timeout:number=60000){
    ...
    command.subcommand('prompt.select <child_type:string> [message]')
        .desc('提示用户输入一个指定类型的列表')
